...
public class TK {
    ...
    public static final TK MONEY = new TK("TK.MONEY"); // $
    ...
    // public static final TK LCBRAK  = new TK("TK.LCBRAK");   // {
    // public static final TK RCBRAK  = new TK("TK.RCBRAK");   // }
    ...
    //public static final TK SEMI   = new TK("TK.SEMI");     // ;
